...
static input int    Magic_Number = 2119603572; // Magic number
...
int GetEntrySignal(void)
  {
   ...
   double ind0val1  = iBearsPower(NULL, 0, Ind0Param0, PRICE_CLOSE, 1);
   double ind0val2  = iBearsPower(NULL, 0, Ind0Param0, PRICE_CLOSE, 2);
...
void ManageClose(void)
  {
   // Momentum (Close, 43), Level: 104.0000
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Bears Power","listIndexes":[5,0,0,0,0],"numValues":[4,0,0,0,0,0]}],"closeFilters":[{"name":"Momentum","listIndexes":[2,3,0,0,0],"numValues":[43,104,0,0,0,0]},{"name":"Pin Bar","listIndexes":[0,0,0,0,0],"numValues":[9,25,0,0,0,0]}]} */
